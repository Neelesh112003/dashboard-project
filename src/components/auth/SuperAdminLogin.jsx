      ...
      <form className="space-y-4" onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <input
            ...
            className="w-full rounded-xl border border-[#30333e]/30 bg-white px-4 py-3 text-sm text-[#30333e] placeholder-[#30333e]/40 shadow-sm outline-none transition-all focus:border-[#44a83e] focus:ring-2 focus:ring-[#44a83e]/20"
            required
            disabled={loading}
          />
        </div>
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              className="w-full rounded-xl border border-[#30333e]/30 bg-white px-4 py-3 pr-12 text-sm text-[#30333e] placeholder-[#30333e]/40 shadow-sm outline-none transition-all focus:border-[#44a83e] focus:ring-2 focus:ring-[#44a83e]/20"
              required
              disabled={loading}
            />
            <button
